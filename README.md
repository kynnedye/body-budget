...
- `USDA_API_KEY` — optional. Free key from [FoodData Central](https://fdc.nal.usda.gov/api-key-signup.html) for better calorie search on generic foods (banana, chicken, rice). Packaged items still search Open Food Facts without a key.
